...
TextureShader::TextureShader(const GLchar *vertexPath, const GLchar *fragmentPath, const GLchar *geometryPath) : Shader(vertexPath, fragmentPath, geometryPath)
{
...
void TextureShader::transmitUniformData(gs2019::Matrix4x4 *modelMatrix, Material *material)
{
